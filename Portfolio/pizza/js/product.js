;(function() {
	...
	var changeProductOrderInfo = function(target) {
		...
		var prodductSize = product.querySelector('.product__size.is-active').textContent;
		...
		order.querySelector('.order-info-size').setAttribute('value', prodductSize);
		...
		order.querySelector('.order__size').textContent = prodductSize;
